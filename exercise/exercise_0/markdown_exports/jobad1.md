...
Description: Building and maintaining a modern data platform at Instabee using GCP and Snowflake, designing data integration patterns, creating CI/CD pipelines with IaC, orchestrating data pipelines with Airflow/DLT, and modeling data with DBT and SQL.
Job title: Joining Instabee's newly formed Data Platform team to shape a modern data infrastructure using cutting-edge technologies. Responsibilities include data integration, pipeline management, and fostering data governance, with collaboration across stakeholders and a focus on agile workflows.
Responsibilities:
 -Leading integration patterns from data sources and building data platform integrations
 -Setting up/maintaining infrastructure for the data platform
 -Implementing CI/CD pipelines using Infrastructure-as-Code (IaC)
 -Orchestrating data pipelines with Airflow or similar tools
 -Modeling data with DBT and SQL, programming in Python/Java/Go
 -Enforcing data governance and trustworthiness through product principles
 -Collaborating with stakeholders to support analytical projects and business processes

- Words in article: 1023
